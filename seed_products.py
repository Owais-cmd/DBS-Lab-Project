#!/usr/bin/env python
"""
Seed 100 real-world products into the database
"""
import sys
import os
sys.path.insert(0, ".")
...
# 100 Real-world products with images from Unsplash/public sources
PRODUCTS = [
    # Electronics
    ...
    {"name": "Fitbit Sense 2", "price": 299.99, "description": "Advanced health tracking smartwatch", "image_url": "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500"},
    ...
    {"name": "Polar Vantage V3", "price": 499.99, "description": "Professional sports watch", "image_url": "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500"},
    ...
    {"name": "Sony A7R V", "price": 3198.00, "description": "High-resolution mirrorless camera", "image_url": "https://images.unsplash.com/photo-1606986628025-35d57e735ae0?w=500"},
    {"name": "Nikon Z9", "price": 5496.95, "description": "Flagship mirrorless camera", "image_url": "https://images.unsplash.com/photo-1606986628025-35d57e735ae0?w=500"},
    {"name": "Fujifilm X-T5", "price": 1699.99, "description": "Retro-styled mirrorless camera", "image_url": "https://images.unsplash.com/photo-1606986628025-35d57e735ae0?w=500"},
    {"name": "Panasonic Lumix S5", "price": 1497.99, "description": "Full-frame mirrorless camera", "image_url": "https://images.unsplash.com/photo-1606986628025-35d57e735ae0?w=500"},
    ...
    {"name": "Omega Seamaster", "price": 5900.00, "description": "Professional dive watch", "image_url": "https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=500"},
    {"name": "Cartier Tank", "price": 6100.00, "description": "Elegant dress watch", "image_url": "https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=500"},
    ...
    {"name": "Gucci Marmont", "price": 1190.00, "description": "Popular shoulder bag", "image_url": "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=500"},
    ...
    {"name": "Balenciaga City Bag", "price": 2145.00, "description": "Contemporary designer bag", "image_url": "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=500"},
    ...
    {"name": "Breville Smart Oven", "price": 599.95, "description": "Digital convection toaster oven", "image_url": "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=500"},
    {"name": "KitchenAid Stand Mixer", "price": 329.99, "description": "Professional stand mixer", "image_url": "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=500"},
    ...
    {"name": "Le Creuset Dutch Oven", "price": 349.99, "description": "Enameled cast iron cookware", "image_url": "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=500"},
    ...
    {"name": "Philips Air Fryer", "price": 249.99, "description": "XL air fryer", "image_url": "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=500"},
    {"name": "Ninja Blender", "price": 99.99, "description": "Powerful blender", "image_url": "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=500"},
    ...
    {"name": "Concept2 Rowing Machine", "price": 895.00, "description": "Professional rowing machine", "image_url": "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=500"},
    {"name": "NordicTrack Treadmill", "price": 799.99, "description": "Smart treadmill with iFit", "image_url": "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=500"},
    ...
    {"name": "Resistance Band Set", "price": 29.99, "description": "5-pack resistance bands", "image_url": "https://images.unsplash.com/photo-1517836357463-d25ddfcb53ef?w=500"},
    {"name": "Jump Rope Pro", "price": 49.99, "description": "Adjustable speed jump rope", "image_url": "https://images.unsplash.com/photo-1517836357463-d25ddfcb53ef?w=500"},
    {"name": "Pull-up Bar", "price": 39.99, "description": "Doorway pull-up bar", "image_url": "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=500"},
    ...
    {"name": "Ab Wheel", "price": 29.99, "description": "Ab roller wheel", "image_url": "https://images.unsplash.com/photo-1517836357463-d25ddfcb53ef?w=500"},
    
    # Books
    {"name": "Atomic Habits", "price": 16.99, "description": "James Clear - Best-selling habits book", "image_url": "https://images.unsplash.com/photo-150784272343-583f20270319?w=500"},
    {"name": "Educated", "price": 18.99, "description": "Tara Westover - Memoir", "image_url": "https://images.unsplash.com/photo-1507842872343-583f20270319?w=500"},
    {"name": "The Midnight Library", "price": 17.99, "description": "Matt Haig - Fiction", "image_url": "https://images.unsplash.com/photo-1507842872343-583f20270319?w=500"},
    ...
    {"name": "The Lean Startup", "price": 15.99, "description": "Eric Ries - Business", "image_url": "https://images.unsplash.com/photo-1507842872343-583f20270319?w=500"},
    {"name": "Dune", "price": 17.99, "description": "Frank Herbert - Sci-Fi Classic", "image_url": "https://images.unsplash.com/photo-1507842872343-583f20270319?w=500"},
    {"name": "Project Hail Mary", "price": 18.99, "description": "Andy Weir - Sci-Fi", "image_url": "https://images.unsplash.com/photo-1507842872343-583f20270319?w=500"},
    ...
    {"name": "Sapiens", "price": 18.99, "description": "Yuval Noah Harari - History", "image_url": "https://images.unsplash.com/photo-1507842872343-583f20270319?w=500"},
    {"name": "The Power of Now", "price": 16.99, "description": "Eckhart Tolle - Self-help", "image_url": "https://images.unsplash.com/photo-1507842872343-583f20270319?w=500"},
    ...
    {"name": "Xbox Series X", "price": 499.99, "description": "Premium gaming console", "image_url": "https://images.unsplash.com/photo-1538481143081-9049b7ad6ff5?w=500"},
    {"name": "Nintendo Switch Pro", "price": 349.99, "description": "Hybrid gaming console", "image_url": "https://images.unsplash.com/photo-1538481143081-9049b7ad6ff5?w=500"},
    ...
    {"name": "Google Nest Hub", "price": 99.99, "description": "Smart display", "image_url": "https://images.unsplash.com/photo-1589003077984-894e133814c9?w=500"},
    {"name": "Apple HomePod mini", "price": 99.00, "description": "Smart speaker", "image_url": "https://images.unsplash.com/photo-1589003077984-894e133814c9?w=500"},
    ...
    {"name": "Nest Thermostat", "price": 249.99, "description": "Smart thermostat", "image_url": "https://images.unsplash.com/photo-1589003077984-894e133814c9?w=500"},
    ...
    {"name": "Smart Plug", "price": 14.99, "description": "WiFi smart plug", "image_url": "https://images.unsplash.com/photo-1589003077984-894e133814c9?w=500"},
    ...
    {"name": "Dermalogica Skincare", "price": 89.99, "description": "Professional skincare set", "image_url": "https://images.unsplash.com/photo-1596386773274-36f9df8fdf4c?w=500"},
    ...
    {"name": "Fender Stratocaster", "price": 799.99, "description": "Electric guitar", "image_url": "https://images.unsplash.com/photo-1510915150049-7ad5254603b1?w=500"},
    ...
    {"name": "MIDI Keyboard Controller", "price": 199.99, "description": "49-key MIDI controller", "image_url": "https://images.unsplash.com/photo-1510915150049-7ad5254603b1?w=500"},
]
...
def seed_products():
    ...
    try:
        ...
        if existing_count > 0 and existing_count < len(PRODUCTS):
            ...
            db.commit()
        elif existing_count >= len(PRODUCTS):
            print(f"Database already has {existing_count} products. Done!")
            return
